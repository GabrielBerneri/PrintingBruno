...
{
    return [
        ['key' => 'home', 'href' => 'index.html', 'label' => 'Inicio', 'icon' => '🏠'],
        ['key' => 'catalogo', 'href' => 'catalogo.html', 'label' => 'Catálogo', 'icon' => '🛒'],
        ['key' => 'nosotros', 'href' => 'nosotros.html', 'label' => 'Nosotros', 'icon' => '👋'],
        ['key' => 'contacto', 'href' => 'contacto.html', 'label' => 'Contacto', 'icon' => '✉️'],
        ['key' => 'cuenta', 'href' => 'mi-cuenta.php', 'label' => 'Mi cuenta', 'icon' => '👤'],
    ];
}
    ...
    <header class="header" id="header">
        <div class="container">
            ...
            <nav class="nav" id="nav">
                ...
                <a href="https://wa.me/5491137022937?text=Hola!%20Quiero%20hacer%20una%20consulta" target="_blank" rel="noopener" class="nav-mobile-cta">
                ...
                <span class="nav-social-label">Seguinos</span>
                <div class="nav-social">
                    ...
                    <?php endif; ?>
                    <button class="theme-toggle" id="themeToggle" aria-label="Cambiar a tema claro">
...
function pb_render_analytics_head(): void
{
    ?>
    <script>
    (function(){var t=localStorage.getItem('pb_theme');if(t==='light')document.documentElement.setAttribute('data-theme','light');})();
    </script>
    <?php
...
<div>
                    ...
                    <ul class="footer-contact">
                        ...
                        <li>
                            ...
                            <a href="mailto:contacto@printingbruno.com">contacto@printingbruno.com</a>
                        </li>
                        <li>
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
