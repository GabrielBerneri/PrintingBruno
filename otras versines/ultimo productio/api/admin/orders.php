...
try {
    if ($_SERVER['REQUEST_METHOD'] === 'GET') {
        ...
        if (isset($body['status'])) {
            ...
            // Check previous status for stock restitution
            ...
            // Restitute stock: approved → cancelled/refunded
            if ($oldStatus === 'approved' && in_array($newStatus, ['cancelled', 'refunded'], true)) {
