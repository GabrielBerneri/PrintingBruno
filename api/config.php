...
define('TRANSFER_BANK_NAME', trim((string)pbEnv('TRANSFER_BANK_NAME', '')));
define('TRANSFER_ACCOUNT_LABEL', trim((string)pbEnv('TRANSFER_ACCOUNT_LABEL', '')));
define('TRANSFER_CBU', trim((string)pbEnv('TRANSFER_CBU', '')));
define('TRANSFER_ALIAS', trim((string)pbEnv('TRANSFER_ALIAS', '')));
define('TRANSFER_ACCOUNT_HOLDER', trim((string)pbEnv('TRANSFER_ACCOUNT_HOLDER', '')));
